...
We have launched a [Discord server](https://discord.gg/QMvnurgKzU) that is open to anyone who wants to share their experiences or seek support with using the OFeed platform. Join us and help make OFeed one of the best tools for managing orienteering event data.
